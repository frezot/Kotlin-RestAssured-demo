...
class FunctionalTests {
    ...
    fun testUserResponse1() {
        ...
        // 2. дата не может быть старше чем появление сервиса (уточнять, пока поставить наугад -10 лет)
        //TODO: implement
    }
    ...
    fun testUserResponse2() {
        // есть смысл поставить границу сверху, по википедии рекорд продолжительности 122 года, 164 дня
        // итого, ограничение 150 будет ок с запасом
        // также у всех знакомств есть нижняя планка для регистрации, можно использовать как проверочный критерий
        // пока нет данных, использую предположение: 14+
        //TODO: implement
    }
